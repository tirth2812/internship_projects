...
def main():
    ...
    # Buttons
    tk.Button(root, text="Add Record", command=on_add).grid(row=10, column=0)
    tk.Button(root, text="Remove Record", command=on_remove).grid(row=10, column=1)
    tk.Button(root, text="Modify Record", command=on_modify).grid(row=10, column=2)
